...
| 约定项 | 说明 |
|--------|------|
| **内存管理** | 元信息模块返回的指针由调用方通过 `pfree()` 释放 |
...
| **乐观锁** | 表更新操作以旧 metadata_location 为乐观锁条件，不匹配时 ereport(P0005, CommitFailedException) |
